...
const curriculumSessions = [
  {
    ...
    isExpanded: true,
    items: [
      { type: "video" as const, title: "What's is Webflow?" },
      { type: "video" as const, title: "Sign up in Webflow" },
      { type: "document" as const, title: "Webflow Terms & Conditions" },
      { type: "video" as const, title: "Teaser of Webflow" },
      { type: "document" as const, title: "Practice Project" },
    ],
  },
  {
    id: "2",
    title: "session 2",
    items: [
      { type: "video" as const, title: "Practice Design Like an Artist" },
    ],
  },
  {
    id: "3",
...
const weekNumbers = [14, 15, 16, 17, 18, 19, 20];
