  ...
  return (
    <div>
      ...
      <div className="relative">
        <select
          className="w-full appearance-none text-gray-500  font-normal rounded-xl border border-gray-300 bg-gray-50 p-2 pr-10"
        >
          {options.map((opt) => (
      ...
      <form className="flex flex-col text-sm">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="max-w-md flex flex-col gap-1 pb-4">
            ...
            <input id="weeklyHours" type="text" className='rounded-xl px-4 py-2 bg-gray-50 border' placeholder='Text' />
          </div>
        </div>
        <div className="flex flex-col gap-1">
          ...
          <div className="max-w-md w-full space-y-4 py-3.5">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 rounded-2xl mb-2 border border-gray-300 bg-gray-50 p-2 text-gray-400">
                <div className="p-1 bg-pink-100 rounded-xl">
                  <IoCloudUploadOutline className="text-[#FF3366]" size={20} />
                </div>
                <span className="truncate">Document Name</span>
              </div>
              <div className="flex items-center gap-2 rounded-2xl  border border-gray-300 bg-gray-50 p-2 text-gray-400">
                <div className="p-1 bg-pink-100 rounded-xl">
                  <IoCloudUploadOutline className="text-[#FF3366]" size={20} />
                </div>
                <span className="truncate">Document Name</span>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="max-w-md flex flex-col gap-1 pt-2 pb-4">
            ...
            <input id="teachingExperience" type="text" className='rounded-xl px-4 py-2 bg-gray-50 border' placeholder='6 years' />
          </div>
          <div className="max-w-md flex flex-col gap-1 pb-4">
            <label className='font-medium text-md' htmlFor="timeServed">Time Served at Edunique (in months)</label>
            <input id="timeServed" type="text" className='rounded-xl px-4 py-2 bg-gray-50 border' placeholder='18 Months' />
          </div>
          <div className="max-w-md flex flex-col gap-1 pb-4">
            <label className='font-medium text-md' htmlFor="hourlyRate">Current Hourly Rate (₹)</label>
            <input id="hourlyRate" type="number" className='rounded-xl px-4 py-2 bg-gray-50 border' placeholder='20000' />
          </div>
          <div className="max-w-md flex flex-col gap-1 pb-4">
            <label className='font-medium text-md' htmlFor="newHourlyRate">Expected New Hourly Rate (₹)</label>
            <input id="newHourlyRate" type="number" className='rounded-xl px-4 py-2 bg-gray-50 border' placeholder='40000' />
          </div>
        ...
        <div className="font-medium flex-wrap flex justify-center gap-2 mt-6 md:mt-8">
          <button
            type="submit"
            className=" rounded-full bg-pink-50 text-sm md:text-base text-[#ff3366] cursor-pointer py-2 px-6 transition duration-200"
          >
            Reject Request
          </button>
          <button
