...
export default function ScheduleMeeting() {
    ...
    return (
        <div className="bg-gray-800 min-h-screen w-full flex items-center justify-center p-4 sm:p-6 lg:p-8">
            <div className="bg-white w-full max-w-5xl rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8">
