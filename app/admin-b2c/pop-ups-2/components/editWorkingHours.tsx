...
const EditWorkingHoursPopup: React.FC<{
    ...
    return (
        <NewBaseModal isOpen={isOpen} onClose={onClose}>
            ...
            <div className="bg-white w-full mx-auto max-w-2xl rounded-2xl shadow-2xl p-6 sm:p-8">
                ...
                <div className="flex items-center gap-3 mt-8">
                    <button onClick={onClose} className="w-full max-w-36 text-center py-3 text-[#6B7280] font-semibold bg-[#E5E7EB] rounded-full hover:bg-gray-300 transition-colors cursor-pointer">
                        Cancel
                    </button>
                    <button onClick={onClose} className="w-full max-w-36 text-center py-3 text-white font-semibold bg-[#3366FF] rounded-full hover:bg-blue-700 transition-colors cursor-pointer">
                        Save
                    </button>
                </div>
