...
const playlistDataPage: PlaylistItemData[] = [
    ...
    { id: 'v2', title: 'Quiz Name ', subtitle: 'Subtitle ', date: '23 / 5 / 25', duration: '15 Mins' },
    { id: 'v3', title: 'Title', subtitle: 'Subtitle ', date: '24 / 5 / 25', duration: '30 Mins', isLocked: true },
    { id: 'v4', title: 'Title', subtitle: 'Subtitle', date: '25 / 5 / 25', duration: '50 Mins', isLocked: true},
    { id: 'v5', title: 'Title', subtitle: 'Subtitle ', date: '26 / 5 / 25', duration: '25 Mins', isLocked: true},
    { id: 'v6', title: 'Title', subtitle: 'Subtitle ', date: '27 / 5 / 25', duration: '20 Mins', isLocked: true},
    { id: 'v7', title: 'Title', subtitle: 'Subtitle ', date: '27 / 5 / 25', duration: '20 Mins', isLocked: true},
    
];
const upcomingQuizDataPage: QuizResultItemData[] = [
    { id: 'q1', name: 'Quiz Alpha', subtitleOrDate: 'Introduction to Topic', date: '23/2/24' },
    { id: 'q2', name: 'Quiz Beta', subtitleOrDate: 'Advanced Concepts', isLocked: true, date: '23/2/24' },
    { id: 'q3', name: 'Quiz Gamma ', subtitleOrDate: 'Final Review', isLocked: true, date: '23/2/24' },
];
const resultDataPage: QuizResultItemData[] = [
    { id: 'r1', name: 'Quiz Name', subtitleOrDate: 'Date', scorePercentage: 60 },
    { id: 'r2', name: 'Quiz Name', subtitleOrDate: 'Date', scorePercentage: 85 },
];
