		...
		<div className="flex flex-col gap-4 p-4  rounded-2xl bg-white">
			...
			<div className="bg-white rounded-2xl  p-4 border border-blue-200 shadow-sm">
				<div className="flex justify-between items-center mb-2">
					<h3 className="text-[20px] font-bold w-[10ch] text-[#3366FF]">Month End Report</h3>
			...
			<div className="bg-gray-100">
				...
				<div className=" bg-white">
					<div className="flex items-center mx-auto max-w-[96rem] gap-3 px-4 sm:px-6 py-3.5 sticky top-0 z-40">
						...
						<h1 className="text-lg sm:text-xl font-semibold text-[#FF3366]">Student List</h1>
					</div>
				</div>
				...
				<div className=" max-w-[93rem]  mx-auto">
					...
					<div className="  rounded-2xl  max-w-[91rem]  mx-auto  bg-[#f9fafb] p-3 border border-[#e5e7eb]">Progress Report</div>
									...
									{lineChartData.datasets.map(dataset => (
										<polyline
											...
											points={dataset.points
												.map(
													(p, i) =>
														`${35 + i * (chartWidth / (lineChartData.labels.length - 1))},${chartHeight - (p / 100) * chartHeight}`
												)
												.join(' ')}
										/>
									))}
