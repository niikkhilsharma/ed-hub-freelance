...
export default function SchoolCodePage() {
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-white  overflow-hidden flex flex-col md:flex-row w-full max-w-4xl lg:max-w-5xl xl:max-w-6xl"
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 mb-auto pt-4 md:pt-0">
            ...
            <p className="text-sm  max-w-[50ch] leading-relaxed">
          ...
          {/* Main Image */}
          <div className="relative top-12 z-10 mt-auto flex justify-center items-end h-full">
            <Image
        ...
        >
          ...
          <p
            className="text-sm mb-6 leading-relaxed text-black max-w-[60ch]">
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry.
          </p>

          <label
            htmlFor="uniqueSchoolCode"
            className="text-base font-medium mt-4 mb-2 block text-black"
          >
            Unique School Code
          </label>
          <input
