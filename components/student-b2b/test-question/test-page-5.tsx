...
"><span className='text-red-500'>Tips: </span>Draw in the box to complete the task</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-3 flex items-center justify-center flex-col">
                        <div className='flex items-center justify-center'>
                            <Image src="/images/pattern.png" alt="Ask me bot" className="w-[400px]" width={400} height={400} />
                        </div>
                        <div className="flex items-center justify-center">
