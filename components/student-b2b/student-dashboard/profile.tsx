...
const FormInput = ({
  ...
  <div className="w-full">
    ...
    <input
      ...
      className="w-full px-4 py-3 bg-gray-100 border border-transparent rounded-3xl text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white"
    />
  </div>
);
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6  md:p-8">
          ...
          <div className="flex items-start  mt-4 mb-8">
            ...
            <div className="mt-3 py-2">
              ...
              <p className="text-xl text-yellow-500 font-medium">Student</p>
            </div>
