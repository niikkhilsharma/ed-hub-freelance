...
const CourseCard = ({ course }: { course: Course }) => {
  ...
  if (course.isKnowledgeBox) {
    return (
      <div className="bg-[#F9FAFB] rounded-2xl shadow-lg p-3 flex flex-col   h-full hover:shadow-xl transition-shadow cursor-pointer">
        ...
        <p className="text-sm text-[#6B7280] w-[30ch] leading-relaxed">
          {course.description}
        </p>
      </div>
    );
  ...
  return (
    <div className="bg-[#F9FAFB] rounded-2xl shadow-lg overflow-hidden flex flex-col h-full hover:shadow-xl transition-shadow">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <p className="text-sm text-gray-500">
          <span className="font-medium text-black">Level / Grade:</span>{" "}
          {course.levelGrade}
        </p>
        {isOngoing && course.pendingClasses && (
          <p className="text-sm text-gray-500">
            <span className="font-medium text-black">Pending Class:</span>{" "}
            {course.pendingClasses}
          </p>
        )}
        {isUpcoming && course.validity && (
          <p className="text-xs text-gray-500">
            <span className="font-medium text-black">
              Validity to start from:
            </span>{" "}
            {course.validity}
          </p>
        )}
                ...
                <div className="w-[55%]  rounded-full">
                  <div
                    className={`h-3 rounded-full ${
                      isCompleted ? "bg-[#8DD9B3]" : "bg-blue-500"
                    }`}
...
const aiSuggestsImages = [
  {
    id: 1,
    src: "/ai-suggests-vr.jpg",
    alt: "VR Learning",
    title: "AR + VR + 3D Animation Drone & Coding",
    subtitle: "Get STEM Certified & Create Apps",
  }, // UPDATE PATHS
  {
    id: 2,
    src: "/ai-suggests-coding.jpg",
    alt: "Coding Class",
    title: "PROGRAMMING",
    subtitle: "Live Concept Classes",
  },
  {
    id: 3,
    src: "/ai-suggests-app-dev.jpg",
    alt: "App Development",
    title: "CODING",
    subtitle: "APP DEVELOPMENT - Learn 7 Coding Languages",
  },
];
          ...
          <div className="flex gap-8 items-center relative z-10 ">
            ...
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
                <h2 className="text-3xl tracking-wider md:text-5xl font-bold">
                  AI suggests
                </h2>
              ...
              <p className="text-sm opacity-90 mb-8 w-[38ch]">
                ...
                Pellentesque placerat lectus et leo fermentum aliquet. Curabitur
                sollicitudin tortor at lacus ultricies, quis blandit sem varius.
              </p>
