...
const HtmlArticle = () => {
  return (
    <div className="font-semibold">
      ...
      <p className="mb-4">
        <span className="text-[#3366FF] font-semibold">The unitary method</span>{" "}
        is a method in which you find the value of a unit and then the value of
        a required number of units.
      </p>
      <p className="mb-4">
        Suppose you go to the market to purchase 6 apples. The shopkeeper tells
        you that he is selling 10 apples for Rs 100. In this case, the apples
        are the units, and the cost of the apples is the value. While solving a
        problem using the unitary method, it is important to recognize the units
        and values.
      </p>
      <p className="mb-6">
        For simplification, always write the things to be calculated on the
        right-hand side and things known on the left-hand side.
      </p>
      ...
      <div className="bg-[#eeeeee] px-3 py-5 rounded-xl space-y-2 shadow-inner mb-6 border border-black max-w-sm mx-auto text-center">
        ...
        <p className="text-lg font-bold text-[#FF3366]">
          1 Apple    = 100/10 = Rs.10
        </p>
        <p className="text-lg font-bold text-[#5fc075]">
      ...
      <p className="mb-4">
        Consider another{" "}
        <span className="text-[#3366FF] font-semibold">example</span>; a car runs
        150 km on 15 litres of fuel, how many kilometres will it run on 10
        litres of fuel?
      </p>
      <p className="mb-4">
        <span className="text-[#3366FF] font-semibold">
          In the above question
        </span>
        , try and identify units (known) and values (unknown).
      </p>
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-4">
        <div className="flex-1">
          ...
          <p>1 litre = 150/15 = 10 km</p>
          <p>10 litres = 10 x 10 = 100 km</p>
          <p className="mt-2 text-[#3366FF] font-semibold">
      ...
      <div className="space-y-6">
        <div>
          <p className="mb-1">
            <span className="text-[#3366FF] font-semibold">Example 1.</span>{" "}
            Income of Amir is Rs 12000 per month, and that of Amit is Rs 191520
            per annum. If the monthly expenditure of each of them is Rs 9960 per
            month, find the ratio of their savings.
          </p>
          ...
          <p className="mt-1">
            <span className="font-semibold text-[#3366FF]">
              Therefore, the ratio of savings of Amir and Amit = 2040:6000 =
              17:50
            </span>
          </p>
        </div>
        <div>
          <p className="mb-1">
            <span className="text-[#3366FF] font-semibold">Example 2.</span> A
            car travelling at a speed of 140 kmph covers 420 km. How much time
            will it take to cover 280 km?
          </p>
          <p className="font-semibold text-[#3366FF]">Solution:</p>
          <p>First, we need to find the time required to cover 420 km.</p>
          <p>Speed = Distance/Time</p>
          ...
          <p>
            280 km = (3/420) x 280 ={" "}
            <span className="text-[#3366FF] font-semibold">2 hours</span>
          </p>
        </div>
        <div>
          <p className="mb-1">
            <span className="text-[#3366FF] font-semibold">Example 3.</span> “A”
            finishes his work in 15 days while “B” takes 10 days. How many days
            will the same work be done if they work together?
          </p>
          {/* Solution for example 3 would go here */}
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl px-3 py-6 relative">
          ...
          <div className="mb-8 flex items-start gap-3">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                <h2 className="text-xl font-bold text-[#FF3366]">
