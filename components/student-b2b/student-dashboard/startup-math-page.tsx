      ...
      <main className="flex-grow container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="bg-white max-w-7xl rounded-2xl shadow-xl relative mx-auto p-2">
          ...
          <div className="flex flex-col lg:flex-row">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div>
                    <h2 className="text-xl font-bold text-[#FF3366]">
                      Startup Maths Part 1{" "}
                    </h2>
                    <p className="text-md text-black mt-1">Learning </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white w-full lg:w-64 xl:w-80 rounded-2xl px-3 py-6 relative flex-shrink-0">
