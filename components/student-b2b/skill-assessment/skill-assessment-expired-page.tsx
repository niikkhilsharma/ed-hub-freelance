...
const TestStatusDisplay = ({ statusText, icon: Icon, iconColor, bgColorClassName }: { statusText: string, icon: React.ElementType, iconColor: string, bgColorClassName: string }) => (
