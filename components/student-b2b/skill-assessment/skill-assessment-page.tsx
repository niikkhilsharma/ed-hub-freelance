			...
			<div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row w-full max-w-4xl lg:max-w-5xl">
				...
				<div className="w-full md:w-4/5 bg-white p-6 sm:p-8 lg:p-10 flex flex-col">
					...
					<div className="flex flex-wrap justify-center gap-3 mb-5 font-bold font-poppins">
						<InfoBadge icon={FiHelpCircle} text="100 Questions" bgColor="bg-orange-300" textColor="text-black-700 " />
						<InfoBadge icon={FiTarget} text="100 Marks" bgColor="bg-sky-200" textColor="text-black-700" />
						<InfoBadge icon={FiClock} text="30 minutes" bgColor="bg-green-200" textColor="text-black-700" />
					</div>
					...
					<div className="bg-gray-50 rounded-xl p-4 text-center shadow-sm">
						<h3 className="text-lg font-semibold text-gray-900 ">Test Window</h3>
						...
						<p className="text-sm text-gray-600">✅ Complete the test within 48 hours or it will reset.</p>
					</div>
