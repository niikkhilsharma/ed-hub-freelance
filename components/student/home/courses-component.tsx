...
const categories: Category[] = [
  "All",
  ...(Array.from(new Set(courses.map((c) => c.category))) as Category[]),
];
// Accept masked prop
export default function CoursesPage({
  ...
  return (
    <div
      className={cn(
        "relative min-h-screen w-full overflow-hidden bg-[#FFF8E8]",
        className
      )}
    >
      {/* Background */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        >
          {!masked && <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-8 text-[#0A2342]">
