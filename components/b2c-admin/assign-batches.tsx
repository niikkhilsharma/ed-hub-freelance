...
const TeacherDroppingForm = () => {
  ...
  return (
    ...
    <div className="max-w-[94rem] mx-auto bg-white p-6  rounded-2xl shadow-sm">
      <h1 className="text-lg font-semibold text-black mb-6">Teacher Dropping</h1>
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full px-4 py-3 border bg-[#faf9fb] border-[#d5d5d5] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-500"
        />
      </div>

      {/* Course Section */}
      <div className="mb-4">
        <h2 className="text-base font-medium text-black mb-2">Course</h2>
        <input
          type="text"
          placeholder="Course Name"
          value={formData.courseName}
          onChange={(e) => handleInputChange('courseName', e.target.value)}
          className="w-full px-4 py-3 border bg-[#faf9fb] border-[#d5d5d5]  rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-500"
        />
      </div>

      {/* Total Batch */}
      <div className="mb-6">
        <h2 className="text-base font-medium text-gray-800 mb-2">Total Batch</h2>
        <input
          type="number"
          value={formData.totalBatch}
          onChange={(e) => handleInputChange('totalBatch', e.target.value)}
          className="w-full px-4 py-3 border bg-[#faf9fb] border-[#d5d5d5]  rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
      </div>
</div>
      {/* Reassign Batches & Students */}
      <div className="mb-8">
        <h2 className="text-lg sm:text-2xl  p-4 bg-[#b0b0b0]/8 rounded-xl font-semibold text-[#3366ff] mb-4">Reassign Batches & Students</h2>
        <div className='w-full mb-4 sm:w-[30%]'>
        {/* Batch 1 */}
        <div className="mb-4">
          ...
          <div className="relative">
            <button
              ...
              className="w-full px-4 py-3 text-left border bg-[#faf9fb] border-[#d5d5d5]  rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent flex items-center justify-between"
            >
