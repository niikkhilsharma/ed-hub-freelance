   ...
   >
     ...
     <div className="flex flex-col w-full gap-4">
       ...
       <div className="w-ful flex gap-2 ">
         ...
         <button className="bg-gray-100 w-full rounded-full p-1 flex items-center gap-2 cursor-pointer justify-center text-gray-600 text-lg"> <MdSettings /> Manage Access</button>
       </div>
     </div>
   </div>
 );
