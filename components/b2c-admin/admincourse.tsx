...
const AdminCourse: React.FC = () => {
  ...
  return (
    <div className="flex gap-6 flex-col sm:flex-row rounded-2xl border border-gray-200 bg-white p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full appearance-none bg-gray-100 rounded-full border border-gray-300 px-4 py-2 pr-10 text-sm"
              >
                <option>Option 1</option>
                <option>Option 2</option>
              </select>
              <FiChevronDown className="absolute right-3 top-8 text-gray-500 pointer-events-none" size={18} />
            </div>
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Text"
                className="w-full rounded-full bg-gray-100 border border-gray-300 px-4 py-2 text-sm"
              />
            </div>
      ...
      <div className="w-full max-w-xs bg-gray-100 border rounded-2xl p-4 ">
        <h3 className="text-base font-semibold mb-3">Select Subjects</h3>
          ...
          {subjects.map((subject, index) => (
            <label key={index} className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="form-radio accent-[#3366ff] w-4 h-4"
              />
