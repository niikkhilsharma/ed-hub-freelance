    ...
    <div className="flex flex-col flex-wrap w-full gap-4">
      ...
      <div className="flex gap-2 w-full flex-wrap xl:flex-nowrap">
        <div className="w-full flex gap-2 ">
          <button className="bg-gray-100 text-nowrap w-full rounded-full p-1 flex items-center gap-2 cursor-pointer justify-center text-gray-600 text-lg"> <MdSettings /> Manage Access</button>
        </div>
        <div className="w-full flex gap-2 ">
