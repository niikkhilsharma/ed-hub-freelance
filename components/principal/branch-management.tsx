		...
		<div className="p-4 ">
			...
			<div className="bg-white rounded-2xl p-4">
				<div className="flex items-center mb-4 gap-2">
					...
					<Button className="bg-gray-100 px-8 py-2 cursow-pointer text-m border rounded-2xl whitespace-nowrap">
						Manage Class
					</Button>
					...
					{branch.map(item => (
						<div key={item.id} className="flex items-center border border-gray-300 gap-4 bg-gray-50 rounded-2xl p-2 shadow-sm">
							...
							<div className="flex gap-2">
								...
								<button className=" bg-blue-500 text-zinc-900 py-2 px-4 text-sm rounded-full">Active</button>
							</div>
						</div>
					))}
				</div>
