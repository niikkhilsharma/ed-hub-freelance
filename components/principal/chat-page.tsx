...
const teachersList: TeacherContact[] = [
  {
    id: `teacher1`,
    name: "Student Name",
    subject: "Class / Batch",
    avatarSrc: `/teacher-b2b/chat-profile.jpg`, // Cycle through 3 avatar examples
    lastMessageTime: "7:00 pm",
    isActive: true, // First teacher active by default
  },
  {
    id: `teacher2`,
    name: "Teacher Name",
    subject: "Subject",
    avatarSrc: `/teacher-b2b/teacher-chat.jpg`, // Cycle through 3 avatar examples
    lastMessageTime: "7:00 pm",
    isActive: false, // First teacher active by default
  },
  {
    id: `teacher3`,
    name: "Student Name",
      ...
      <div className="bg-gray-100">
        <main className="flex-grow container mx-auto p-4 sm:p-6 lg:p-8 flex gap-5 items-start">
          ...
          <div className="w-full md:w-1/3 lg:w-1/4 bg-white rounded-3xl shadow-xl p-4 self-stretch">
            {" "}
            {/* self-stretch */}
            <h2 className="text-lg font-bold text-[#FF3366] mb-3 px-2">Chat</h2>
            <div className="relative w-full mb-3">
              <FaSearch className="absolute top-1/2 left-3 transform -translate-y-1/2 text-black text-sm" />
              <input
                type="text"
                placeholder="Search"
              ...
              <>
                ...
                <div className="p-4 shrink-0">
                  ...
                  >
                    ...
                    <button
                      type="button"
                      className="p-2 text-[#6B7280] cursor-pointer hover:text-blue-600 focus:outline-none"
                    >
