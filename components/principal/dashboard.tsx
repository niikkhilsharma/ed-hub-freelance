...
const PROFILE_SUBTEXT_COLOR = "#FFCC00";
const PRINCIPAL_TAG_BG = "#FEF3C7"; // Light yellow
const PRINCIPAL_TAG_TEXT = "transparent"; // Dark yellow/brown
const STAT_CARD_BG = "#F9FAFB";
const STAT_NUMBER_COLOR = "#3366FF"; // Blue
const STAT_LABEL_COLOR = "black";
const CHART_DATE_FILTER_BG = "#F9FAFB";
const CHART_DATE_FILTER_TEXT = "black";
const CHART_AXIS_COLOR = "#7D7D7D";
const CHART_LINE_COLOR_OVERALL = "#25CD2566"; // Green
const BAR_CHART_BAR_COLOR = "#3366FF"; // Blue
const BAR_CHART_LABEL_COLOR = "black";
...
const PROGRESS_POSITIVE_COLOR = "#28A745"; // Green
const PROGRESS_NEGATIVE_COLOR = "#DC3545"; // Red
...
const StatCard: React.FC<StatCardProps> = ({ number, label }) => (
  <div
    className={`p-6 rounded-xl text-center border border-[#E5E7EB]`}
