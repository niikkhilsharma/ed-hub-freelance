					...
					<div className="bg-white p-6 rounded-xl">
						...
						<div className="space-y-2">
							{sessionData.map((item, index) => {
								...
								return (
									<div key={index} className="bg-gray-100 p-2 rounded-2xl shadow-md overflow-hidden transition-all">
										<button
									...
									<table className="w-full table-auto border-collapse text-sm">
										<thead>
											<tr className="bg-blue-200">
												<th className="border border-black px-3 py-2 text-left" colSpan={2}>
													INTERNAL ASSESSMENT
												</th>
