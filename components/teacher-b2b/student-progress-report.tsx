            ...
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 p-2 md:p-5 gap-6">
                    ...
                    >
                        <div className="flex  items-start sm:items-center gap-4">
                            ...
                            <div
                                className="text-[11px] font-medium text-right sm:text-left space-y-0.5 text-black"
                            >
                                <p>Gender: Male</p>
                                <p>DOB: 15 Jun 2015</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-[1fr_1fr] p-2 md:p-5 md:grid-cols-[2fr_1fr] gap-4">
                    ...
                    >
                        ...
                        <div className="space-y-3 max-h-80 custom-scrollbar overflow-y-auto pr-3 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 scrollbar-thumb-rounded-full">
                            {" "}
                            {/* Custom scrollbar */}
