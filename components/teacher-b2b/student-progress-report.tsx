...
const StudentReport: React.FC = () => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 p-2 md:p-5 gap-6">
                ...
                >
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                        ...
                        <div
                            className="text-[11px] font-semibold text-right sm:text-left space-y-0.5 text-black"
                        >
                            <p>Gender: Male</p>
                            <p>DOB: 15 Jun 2015</p>
                ...
                >
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
                        ...
                        <div className="flex items-center gap-2 mt-2 sm:mt-0">
                            <div
                                className="bg-gray-100 shadow-sm flex items-center gap-1  rounded-lg p-1 text-sm"
                            >
                                <span>{currentMonth}</span>
                                <FiChevronDown className="w-3 h-3 ml-1" />
                            </div>
                            <div className="bg-gray-100 shadow-sm flex items-center gap-1  rounded-lg p-1">
                                <button
                                className="p-1"
                            >
                                <FiChevronLeft
                                    className="w-3.5 h-3.5 border border-1 border-black rounded-full"
                                />
                            </button>
                            <span
    ...
    bg-gray-100">
                ...
                <div
                    className="p-5 h-full custom-scrollbar rounded-2xl overflow-y-auto shadow-sm rounded-2xl bg-white row-span-2"
