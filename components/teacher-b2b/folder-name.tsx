  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 relative min-h-screen flex flex-col">
      ...
      <button
        ...
        className="sticky w-32 self-end  text-center bottom-8 right-8 sm:bottom-12 sm:right-12 z-50 bg-yellow-500 text-white font-semibold px-5 py-3 rounded-full shadow-lg hover:bg-yellow-600 transition-colors flex items-center justify-center gap-2 text-sm"
