...
interface ProgressCircleProps {
  ...
  color: string; // Border color for the circle
  skillName: string;
  details: string;
}

const ProgressCircleItem: React.FC<ProgressCircleProps> = ({
  percentageText,
  color,
  skillName,
  details,
  ...
  <div className="flex items-center space-x-3">
    ...
    <div>
      <p className="text-xs font-medium text-gray-800">{skillName}</p>
...
const StudentDashboardPage: React.FC = () => {
  ...
  const skillCardData = [
    {
      ...
      progressPercent: 80,
      iconSet: [
        <FiSearch key="s" className="w-3 h-3" />,
        <FiPercent key="p" className="w-3 h-3" />,
        <FiAward key="a" className="w-3 h-3" />,
      ],
      skills: Array(6).fill({
        name: "Subject 1",
    ...
    },
    {
      ...
      progressPercent: 80,
      iconSet: [
        <FiBarChart2 key="b" className="w-3 h-3" />,
        <FiAward key="a" className="w-3 h-3" />,
        <FiZap key="z" className="w-3 h-3" />,
      ],
      skills: [
        {
          name: "Spoken English",
  ...
  return (
    <div
      style={{ backgroundColor: PALETTE.BG_PAGE }}
    ...
    >
      ...
      <main className="flex-grow container mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        {/* Top Section: Student Info & Classes Summary */}
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="flex-grow">
                ...
                <div className="flex flex-wrap items-center gap-1 mt-2">
                  ...
                  <span
                    className="text-xs font-medium px-2.5 py-1.5 rounded-r-full"
                    style={{
                      backgroundColor: PALETTE.ACCENT_PINK,
                      color: PALETTE.WHITE_CARD,
                    }}
              ...
              <div
                className="text-[11px] text-right sm:text-left space-y-0.5 text-black"
              >
                <p>Gender: Male</p>
                <p>DOB: 15 Jun 2015</p>
        ...
        {/* Overall Progress & Personal Development */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
              ...
              <div className="flex items-center gap-2 mt-2 sm:mt-0">
                <div
                  className="flex items-center text-xs px-2 py-1.5 rounded-md border"
                  style={{
                    borderColor: PALETTE.BORDER_GREY,
              ...
              >
                ...
                {lineChartData.labels.map((label, i) => (
                  <text
                    key={label}
                    x={
                      35 + i * (chartWidth / (lineChartData.labels.length - 1))
                    }
                    y={chartHeight + 20}
                    fontSize="10"
          ...
          >
            ...
            <div className="space-y-3 max-h-80 overflow-y-auto pr-3 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 scrollbar-thumb-rounded-full">
              {" "}
              {/* Custom scrollbar */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          {skillCardData.map((card, cardIndex) => (
            ...
            >
              ...
              <div className="space-y-3 max-h-60 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-transparent scrollbar-thumb-rounded-full">
          ...
          >
            ...
            <p className="text-xs mb-1" style={{ color: PALETTE.TEXT_MEDIUM }}>
              Overall Progress
            </p>
            <div className="flex items-center mb-3">
              <span
        ...
        >
          <table className="w-full text-xs">
            <thead style={{ backgroundColor: PALETTE.BG_PAGE }}>
              <tr>
                {[
                  "Test",
                  "Date",
                  ...
                  <th
                    key={header}
                    className="p-2.5 text-left font-semibold"
                    style={{ color: PALETTE.TEXT_MEDIUM }}
                  >
                    {header}
                  </th>
