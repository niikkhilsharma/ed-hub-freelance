...
export const sampleUnitaryItems: UnitaryItemData[] = [
  {
    ...
    subtitle: "Introduction to algebraic expressions",
  },
  {
    id: "u2",
    title: "Newton's Laws",
    subtitle: "Fundamental principles of motion",
  },
        ...
        <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
          ...
          <div className="flex items-center space-x-2 self-end sm:self-center">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium border-2 border-[${PRIMARY_BLUE}] text-[${PRIMARY_BLUE}] bg-white hover:bg-blue-50 rounded-lg shadow-sm transition-colors`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium text-white bg-[${PRIMARY_BLUE}] hover:opacity-90 rounded-lg shadow-sm transition-opacity`}
            >
