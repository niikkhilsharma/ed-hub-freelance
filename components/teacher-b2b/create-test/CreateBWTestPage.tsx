...
export const AVATAR_PLACEHOLDER = 'https://picsum.photos/seed/student/80/80?grayscale' // Increased size for StudentSelectItemCard
...
export const QuestionPointsInput: React.FC<{
	...
	<div className="flex items-center space-x-1.5">
		...
		<DurationPointInput name={`q_points_${uuidv4()}`} label="" value={value} onChange={onChange} isPoints={true} />
	</div>
)
