  ...
  const renderActionButtons = () => {
    switch (currentStep) {
        case 1:
          return (
            <>
              <button type="button" onClick={handleCancel} className="px-6 py-3 text-md font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-full transition-colors">Cancel</button>
              <button type="button" onClick={handleNextOrSubmit} className={`px-8 py-2.5 text-sm font-medium text-white bg-[${PRIMARY_BLUE}] hover:opacity-90 rounded-full transition-opacity`}>Continue</button>
            </>
          );
        case 2:
          return (
            <>
              ...
              <button type="button" onClick={handleUploadFile} className={`${YELLOW_BUTTON_BG} ${YELLOW_BUTTON_TEXT} px-6 py-3 text-md font-medium hover:opacity-90 rounded-full transition-opacity`}>Upload File</button>
            </>
          );
        case 3:
          return (
