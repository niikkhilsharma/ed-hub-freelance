...
const CreateBWTestContent: React.FC<{ currentStep: number, setCurrentStep: React.Dispatch<React.SetStateAction<number>>, testType: string }> = ({ currentStep, setCurrentStep, testType }) => {
      ...
      case 2:
        return (
          <div className="grid grid-cols-2 w-full gap-2 sm:flex sm:justify-center sm:items-center sm:gap-4">
            ...
            <button type="button" className={`w-full sm:w-auto px-3 py-2.5 text-sm sm:px-6 sm:py-3 sm:text-md font-medium text-white bg-[${PRIMARY_BLUE}] hover:opacity-90 rounded-full transition-opacity`}>
              Save
            </button>
      ...
      case 3:
        return (
          <>
            ...
            <button type="button" className={`w-full sm:w-auto px-5 py-2.5 text-sm sm:px-6 sm:py-3 sm:text-md font-medium text-white bg-[${PRIMARY_BLUE}] hover:opacity-90 rounded-full transition-opacity`}>
              Save
            </button>
