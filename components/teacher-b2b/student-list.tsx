...
const GeneralFilterButton: React.FC<{
  ...
  <button
    onClick={onClick}
    className={`flex items-center justify-center gap-1.5 px-3 py-1.5 sm:px-3.5 sm:py-2.5 border border-gray-300 bg-[#F9FAFB] text-black rounded-xl text-xs  whitespace-nowrap shadow-sm hover:bg-gray-100 flex-shrink-0 transition-colors`}
  >
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="relative flex-grow">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 border border-[#6B7280] bg-white rounded-full focus:ring-2 focus:ring-[#3366FF] focus:border-transparent outline-none text-sm shadow-sm appearance-none"
          />
        </div>
