    ...
    <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8">
      ...
      {currentStep === 1 && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            {/* Student Selection */}
            <div
              className={`p-4 rounded-lg border ${INPUT_BORDER} bg-slate-50`}
            >
              <div className="flex items-center space-x-4 mb-3">
                <label className="flex items-center space-x-1.5 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-black">For all</span>
                </label>
                <label className="flex items-center space-x-1.5 cursor-pointer">
                  <input
                    type="radio"
              ...
              {studentAssignType === "selective" && (
                <>
                  ...
                  <div
                    className={`space-y-2 max-h-60 overflow-y-auto pr-1 scrollbar-thin ${SCROLLBAR_THUMB_ORANGE} ${SCROLLBAR_TRACK_LIGHT}`}
                  >
      ...
      <div className="mt-8 pt-6 border-t border-gray-200 flex justify-end space-x-3">
        <button
          ...
          className="px-6 py-2.5 text-sm font-medium text-black bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black"
        >
          Cancel
        </button>
        <button
          ...
          className={`px-8 py-2.5 text-sm font-medium text-white bg-[${PRIMARY_BLUE}] hover:opacity-90 rounded-lg transition-opacity focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[${PRIMARY_BLUE}]`}
        >
