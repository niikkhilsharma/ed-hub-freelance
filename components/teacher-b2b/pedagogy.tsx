...
const INFO_PANEL_BG = "bg-white"; // Background for the right info panel
...
const PedagogyContent: React.FC = () => {
  ...
  const [pedagogyData, setPedagogyData] =
    useState<PedagogyInfo>(samplePedagogyInfo); // This should be dynamic
