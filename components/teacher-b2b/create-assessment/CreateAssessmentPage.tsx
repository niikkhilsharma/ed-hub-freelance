...
export const FormField: React.FC<{
  ...
  <div>
    <label
      htmlFor={name}
      className="block text-md font-medium text-black mb-1.5"
    >
      {label}
    </label>{" "}
    ...
    <div className="bg-[#eeeeee] min-h-screen flex flex-col">
      ...
      <div className="bg-gray-100">
        <div className="bg-white px-4 sm:px-6 py-3  sticky top-0 z-40">
          <div className="">
            <div className="flex max-w-[96rem] mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 ">
             <div className="flex"> <button
              ...
              <div className="flex items-center justify-between  gap-3 self-start sm:self-center">
                <button
