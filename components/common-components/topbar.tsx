...
export const OptimizedCategoryTabsBar: React.FC<MainCategoryTabsBarProps> = ({ categories, activeCategory, onCategoryClick }) => {
        ...
        <div className=" max-w-[96rem] bg-white mx-auto rounded-2xl py-2">
            <div className="relative flex items-center">
                ...
                <button
                    ...
                    className="hidden md:block absolute left-2 top-1/2 -translate-y-1/2 z-20 p-2 rounded-full hover:bg-gray-100 transition-colors"
                    aria-label="Scroll left"
                >
                    <FiArrowLeft className="w-5 h-5 text-black" strokeWidth={2.5} />
                </button>
